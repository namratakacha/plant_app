class Plant {
  ...
  static List<Plant> getFavoritedPlants(){
    List<Plant> _favoritePlants = Plant.plantList;
    return _favoritePlants.where((element) => element.isFavorated == true).toList();
  }

  //Get the cart items
  static List<Plant> addedToCartPlants(){
    List<Plant> _cartPlants = Plant.plantList;
    return _cartPlants.where((element) => element.isSelected == true).toList();
  }
}
